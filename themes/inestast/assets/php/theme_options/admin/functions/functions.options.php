...
$of_options[] = array( 	"name" 		=> "Background Video  Thumb for old and mobile devices
",
						"desc" 		=> "",
...
$of_options[] = array( 	"name" 		=> "Enable Text Slideshow",
						"desc" 		=> "",
...
$of_options[] = array( 	"name" 		=> "Contact Success",
						"desc" 		=> "",
						"id" 		=> "contact_success",
