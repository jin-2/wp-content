...
<script>
	jQuery(document).ready(function() {
		var option_bg;
		option_bg = jQuery("#background_type option:selected").text();
		if(option_bg === "Image") {
				jQuery("#background_color").parent().parent().parent().parent().css("display","none");
				jQuery("#background_image").parent().parent().parent().parent().css("display","block");
				jQuery("#background_parallax").parent().parent().parent().parent().css("display","block");
		}
			
		if(option_bg === "Color") {
				jQuery("#background_image").parent().parent().parent().parent().css("display","none");
				jQuery("#background_parallax").parent().parent().parent().parent().css("display","none");
				jQuery("#background_color").parent().parent().parent().parent().css("display","block");
		}
		
		jQuery("#background_type").change(function() {
			option_bg = jQuery("option:selected",this).text();
			if(option_bg === "Image") {
				jQuery("#background_color").parent().parent().parent().parent().css("display","none");
				jQuery("#background_image").parent().parent().parent().parent().css("display","block");
				jQuery("#background_parallax").parent().parent().parent().parent().css("display","block");
